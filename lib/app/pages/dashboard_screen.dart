        ...
        child: Center(
          child: Container(
            ...
            child: Stack(
              children: [
                // Pages
                IndexedStack(index: _selectedNavIndex, children: _pages),
                        ...
                        children: [
                          _NavButton(
                            ...
                            onTap: () {
                              ...
                              _homeTabKey.currentState?.reloadProfile();
                            },
                          ),
...
class HomeTabState extends State<_HomeTab> {
  ...
  final List<_MoodOption> _moods = [
    _MoodOption(icon: Icons.sentiment_very_dissatisfied, label: 'Very Sad'),
    _MoodOption(icon: Icons.sentiment_dissatisfied, label: 'Sad'),
    _MoodOption(icon: Icons.sentiment_neutral, label: 'Neutral'),
    _MoodOption(icon: Icons.sentiment_satisfied, label: 'Happy'),
    _MoodOption(icon: Icons.sentiment_very_satisfied, label: 'Very Happy'),
  ];
  ...
  Future<void> _loadUserProfile() async {
    ...
    setState(() {
      ...
      _userAvatarUrl = prefs.getUserAvatarUrl(defaultValue: _userAvatarUrl);
      _isLoading = false;
    });
    log('Profile loaded — name: $_userName');
  }

  /// Called by DashboardScreen via GlobalKey when switching back to home tab
                      ...
                      (i) => GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Icon(
                            ...
                            color: _selectedMoodIndex == i
                                ? AppColors.primary
                                : AppColors.textWhite80.withAlpha(90),
                          ),
                        ),
                      ),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            height: 40,
                            decoration: BoxDecoration(
                              color: AppColors.primaryContent.withAlpha(25),
                          ...
                          Text(
                            ...
                            style: AppStyles.bodySmall.copyWith(
                              fontSize: 12,
                              color: AppColors.primaryContent.withAlpha(205),
                            ),
                          ),
                        ],
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              height: 40,
                              decoration: BoxDecoration(
                                color: tip.backgroundColor.withAlpha(77),
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Icon(
                                tip.icon,
...
class _MoodOption {
  final IconData icon;
  final String label;
  _MoodOption({required this.icon, required this.label});
}
